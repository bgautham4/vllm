...
class Scheduler:
    ...
    def __init__(
        ...
        self.prefill_batch_size = self.scheduler_config.prefill_batch_size
        self.batched_mode = self.scheduler_config.batched_mode
        self.last_time = 0.0
    ...
    def _my_schedule_batched(self) -> SchedulerOutputs:
        # WARN: Use this mode only for the batched experiments.
    ...
    def _schedule(self) -> SchedulerOutputs:
        ...
        if self.scheduler_config.prefill_batch_size is not None:
            if self.batched_mode:
                return self._my_schedule_batched()
            else:
